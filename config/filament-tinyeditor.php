...
return [
    ...
    'profiles' => [
        ...
        'custom' => [
            'plugins' => 'autoresize directionality emoticons link wordcount image lists ',
            'toolbar' => 'removeformat | formatselect | bold italic | bullist numlist | rtl ltr alignjustify alignright aligncenter alignleft | link | image',
            'fontsize_formats' => '16pt 18pt 24pt 36pt',
            'upload_directory' => null,
        ],
    ],
